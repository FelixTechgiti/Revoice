...
(function (global) {
  ...
  const STRINGS = {
    en: {
      ...
      cfgAirplay2Missing: 'the AirPlay 2 receiver is not on this Echo yet — it arrives with the next endpoint update',
    ...
    de: {
      ...
      cfgAirplay2Missing: 'der AirPlay-2-Empfänger ist noch nicht auf diesem Echo — er kommt mit dem nächsten Endpunkt-Update',
