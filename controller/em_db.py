...
MIGRATIONS: list[str] = [
    ...
    # ── v25 — remember WHICH emOS each device booted ─────────────────────────
    #
    ...
    #
    # RENUMBERED from v23 in the 2026-09-21 upstream sync, which took 23
    # and 24. The stored schema_version is an INDEX into this list, so the
    # only safe resolution is to append: renumbering upstream's would
    # corrupt every database that has already run them.
    """
